...
export function ensureOverlay(getActiveRoom: () => any, getActionContext: () => any): HTMLDivElement {
    ...
    if (!overlay) {
        ...
        // FIXED: Shift the overlay up so it perfectly clears the stat bars!
        ...
        // FIXED: The Top-Right Flex Column. Maps, Coins, and Coordinates will now naturally stack.
        ...
        // Nested Container specifically for Rank/Coins so the update loop doesn't wipe the whole flexbox
        let rankCoinsDiv = document.createElement("div");
        rankCoinsDiv.id = "hud-rank-coins";
        topRightDiv.appendChild(rankCoinsDiv);

        const minimapContainer = document.createElement("div");
        minimapContainer.id = "minimap-container";
        minimapContainer.style.position = "relative"; // Changed from fixed
        ...
        // Append minimap to the Flex Column!
        ...
        if (!coordDiv) {
            ...
            coordDiv.style.position = "relative"; // Changed from fixed
            ...
            // Append coords to the Flex Column!
...
export function updateHUD(
   ...
   const eventDiv = document.getElementById("global-event-banner");
    ...
    // TARGET ONLY THE RANK/COINS DIV SO WE DONT OVERWRITE THE MINIMAP FLEXBOX
