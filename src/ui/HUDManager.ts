...
export function openInventoryUI(activeRoom: any, keys: any, playerClass: string) {
    ...
    document.getElementById("inventory-list-container")!.onclick = (e) => {
        const target = e.target as HTMLElement;
...
export function openChestUI(activeRoom: any, keys: any, chestId: string) {
    ...
    document.getElementById("chest-backpack-container")!.onclick = (e) => {
        const target = e.target as HTMLElement;
    ...
    document.getElementById("chest-contents-container")!.onclick = (e) => {
        const target = e.target as HTMLElement;
...
export function openShopUI(activeRoom: any, keys: any, stallType: string) {
    ...
    document.getElementById("shop-vault-container")!.onclick = (e) => {
        const target = e.target as HTMLElement;
    ...
    document.getElementById("shop-items-container")!.onclick = (e) => {
        const target = e.target as HTMLElement;
        if (target.tagName !== "BUTTON") return;
